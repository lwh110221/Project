...
C. 光交换技术
D. 光接入技术
答案：ABCD `;function Fa(n){const e=n.split("**").filter(r=>r.trim()),t=[];let s="";return e.forEach(r=>{if(r.includes("单选题"))s="single";else if(r.includes("判断题"))s="boolean";else if(r.includes("多选题"))s="multiple";else if(r.trim()){const o=r.split(`
`).filter(i=>i.trim());o.forEach(i=>{if(i.match(/^\d+\./)){const c={type:s,content:i.replace(/^\d+\./,"").trim(),options:[],answer:""};if(s==="single"||s==="multiple"){const l=o.slice(o.indexOf(i)+1),f=[];for(const u of l)if(u.match(/^[A-D]\./))f.push(u.trim());else if(u.includes("答案：")){s==="multiple"?c.answer=u.replace("答案：","").trim().split(""):c.answer=u.replace("答案：","").trim();break}c.options=f}else if(s==="boolean"){c.options=["正确","错误"];const l=o[o.indexOf(i)+1];l&&l.includes("答案：")&&(c.answer=l.replace("答案：","").trim())}t.push(c)}})}}),{title:"题库",questions:t}}async function $a(){var n;try{const e=[],t=Object.assign({"/quizbanks/信息通信-1.md":wa,"/quizbanks/信息通信-2.md":Ea,"/quizbanks/信息通信-3.md":Pa,"/quizbanks/信息通信-4.md":Ta,"/quizbanks/光纤通信考点专项-1.md":Ra,"/quizbanks/数字化新技术基础理专项-1.md":Oa,"/quizbanks/数据库系统考点专项-1.md":ka,"/quizbanks/数据结构考点专项（偏概念）.md":Ma,"/quizbanks/计算机网络考点专项-1.md":Ia,"/quizbanks/通信原理考点专项-1.md":La,"/quizbanks/通信网理论考点专项-1.md":Na});for(const[s,r]of Object.entries(t)){const o=((n=s.split("/").pop())==null?void 0:n.replace(".md",""))||"",i=Fa(r);i.title=o,e.push(i)}return e}catch(e){return console.error("Failed to load quiz banks:",e),[]}}const Ha={class:"max-w-4xl mx-auto p-4"},ja={class:"grid grid-cols-1 md:grid-cols-2 gap-4"},Qa=["onClick"],Ua={class:"text-xl font-semibold text-gray-800 dark:text-white"},za={class:"text-gray-600 dark:text-gray-300"},Ka=qe({__name:"QuizSelector",setup(n){const e=nr(),t=er(),s=Un([]);qt(async()=>{s.value=await $a()});const r=o=>{t.setQuizBank(o),e.push("/quiz")};return(o,i)=>(hn(),Cn("div",Ha,[i[0]||(i[0]=L("h1",{class:"text-2xl font-bold mb-6 text-gray-800 dark:text-white"},"选择题库",-1)),L("div",ja,[(hn(!0),Cn(Tn,null,xt(s.value,c=>(hn(),Cn("div",{key:c.title,class:"border rounded-lg p-4 cursor-pointer bg-white dark:bg-gray-700 hover:bg-green-200 dark:hover:bg-green-700 transition-colors",onClick:l=>r(c)},[L("h2",Ua,xn(c.title),1),L("p",za,"题数: "+xn(c.questions.length),1)],8,Qa))),128))])]))}}),Va={class:"max-w-4xl mx-auto"},qa={class:"mb-1 bg-white dark:bg-gray-800 rounded-xl shadow-sm p-3"},Wa={class:"relative"},Ga={class:"flex mb-2 items-center justify-between"},Ya={class:"text-sm font-medium text-blue-600 dark:text-blue-400"},Ja={class:"h-3 bg-blue-100 dark:bg-blue-900 rounded-full"},Xa={class:"p-4"},Za={class:"flex justify-between items-center mb-4"},nf={class:"grid grid-cols-5 gap-2"},ef=["onClick"],tf={key:0,class:"absolute -top-1 -right-1 w-3 h-3 bg-red-500 rounded-full"},sf={key:1,class:"bg-white dark:bg-gray-800 rounded-xl shadow-lg min-h-[600px] flex flex-col"},rf={class:"flex-1 p-8 overflow-y-auto"},of={class:"flex justify-between items-center mb-6"},lf={class:"flex items-center gap-4"},cf={class:"text-xl font-bold text-gray-800 dark:text-white"},uf={class:"flex items-center gap-4"},af={class:"px-3 py-1 bg-blue-50 dark:bg-blue-900 text-blue-600 dark:text-blue-400 rounded-full text-sm"},ff={class:"text-lg mb-8 text-gray-700 dark:text-gray-200"},df={class:"space-y-4"},hf=["onClick"],pf=["onClick"],gf={class:"border-t border-gray-100 dark:border-gray-700 p-6 bg-white dark:bg-gray-800 rounded-b-xl"},Cf={class:"flex justify-between items-center max-w-2xl mx-auto"},Af=["disabled"],mf=["disabled"],Bf={key:2,class:"fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50"},Df={class:"bg-white dark:bg-gray-800 rounded-lg p-6 max-w-sm w-full mx-4"},vf={class:"flex justify-end gap-4"},bf=qe({__name:"QuizQuestion",setup(n){const e=nr(),t=er(),s=Un(!1),r=Un([]),o=Un(""),i=Un(!1),c=Un(!1),l=An(()=>{var D;return(D=t.currentQuizBank)==null?void 0:D.questions[t.currentQuestionIndex]}),f=An(()=>t.currentQuestionIndex),u=An(()=>t.progress),d=An(()=>t.currentQuizBank?f.value===t.currentQuizBank.questions.length-1:!1),p=An(()=>{var D;return((D=t.currentQuizBank)==null?void 0:D.questions.length)||0});ze(()=>f.value,D=>{const _=t.getSavedAnswer(D);_?(Array.isArray(_)?r.value=_:o.value=_,i.value=!0,s.value=!0):(r.value=[],o.value="",i.value=!1,s.value=!1)},{immediate:!0});const g=D=>{s.value||(o.value=D,i.value=!0,s.value=!0,t.submitAnswer(D))},y=()=>{!l.value||!i.value||(s.value=!0,t.submitAnswer(r.value))},E=()=>{d.value?c.value=!0:t.nextQuestion()},j=()=>{f.value>0&&t.previousQuestion()},F=D=>{var w,G,fn;if(!s.value)return"hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200";const _=o.value===D,k=((w=l.value)==null?void 0:w.type)==="boolean"?((G=l.value)==null?void 0:G.answer)===D:(fn=l.value)==null?void 0:fn.answer.includes(D);return _&&k?"bg-green-100 dark:bg-green-900/50 border-green-500 border text-gray-700 dark:text-gray-200":_&&!k?"bg-red-100 dark:bg-red-900/50 border-red-500 border text-gray-700 dark:text-gray-200":!_&&k?"bg-green-100 dark:bg-green-900/50 border-green-500 border text-gray-700 dark:text-gray-200":"border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200"},I=D=>{var w;if(!s.value)return r.value.includes(D)?"bg-blue-100 dark:bg-blue-900/50 border-blue-500 border text-gray-700 dark:text-gray-200":"hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200";const _=r.value.includes(D),k=Array.isArray((w=l.value)==null?void 0:w.answer)&&l.value.answer.includes(D);return _&&k?"bg-green-100 dark:bg-green-900/50 border-green-500 border text-gray-700 dark:text-gray-200":_&&!k?"bg-red-100 dark:bg-red-900/50 border-red-500 border text-gray-700 dark:text-gray-200":!_&&k?"bg-green-100 dark:bg-green-900/50 border-green-500 border text-gray-700 dark:text-gray-200":"border border-gray-200 dark:border-gray-600 text-gray-700 dark:text-gray-200"},N=D=>{if(s.value)return;const _=r.value.indexOf(D);_===-1?r.value.push(D):r.value.splice(_,1),i.value=r.value.length>0},R=Un(!1),z=An(()=>t.markedQuestions.has(f.value)),Z=()=>{t.toggleMarkQuestion(f.value)},Y=D=>{t.jumpToQuestion(D),R.value=!1},V=()=>{c.value=!1,e.push("/result")};return(D,_)=>(hn(),Cn("div",Va,[R.value?(hn(),Cn("div",{key:0,class:"fixed inset-0 bg-black bg-opacity-50 z-40",onClick:_[0]||(_[0]=k=>R.value=!1)})):Pe("",!0),L("div",qa,[L("div",Wa,[L("div",Ga,[_[5]||(_[5]=L("span",{class:"text-sm font-medium text-blue-600 dark:text-blue-400"},"做题进度",-1)),L("span",Ya,xn(Math.round(u.value))+"%",1)]),L("div",Ja,[L("div",{class:"h-2 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 transition-all duration-500",style:Qt({width:`${u.value}%`})},null,4)])])]),L("div",{class:ie(["fixed right-0 top-0 h-full bg-white dark:bg-gray-800 shadow-lg transform transition-transform duration-300 z-50",R.value?"translate-x-0":"translate-x-full"]),style:{width:"300px"}},[L("div",Xa,[L("div",Za,[_[7]||(_[7]=L("h3",{class:"text-lg font-bold text-gray-800 dark:text-white"},"题目导航",-1)),L("button",{onClick:_[1]||(_[1]=k=>c.value=!0),class:"cursor-pointer bg-gradient-to-r from-[#EB3349] to-[#F45C43] px-2 py-1 rounded text-white text-sm font-semibold shadow-md hover:opacity-90"},"交卷"),L("button",{onClick:_[2]||(_[2]=k=>R.value=!1),class:"text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"},_[6]||(_[6]=[L("span",{class:"sr-only"},"关闭",-1),L("svg",{class:"w-6 h-6",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[L("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M6 18L18 6M6 6l12 12"})],-1)]))]),L("div",nf,[(hn(!0),Cn(Tn,null,xt(p.value,k=>(hn(),Cn("button",{key:k-1,onClick:w=>Y(k-1),class:ie(["w-10 h-10 rounded-lg flex items-center justify-center relative",[f.value===k-1?"bg-blue-600 text-white":"bg-gray-100 dark:bg-gray-700 dark:text-gray-200",zn(t).userAnswers.has(k-1)&&zn(t).isAnswerCorrect(k-1)?"border-2 border-green-500":"",zn(t).userAnswers.has(k-1)&&!zn(t).isAnswerCorrect(k-1)?"border-2 border-red-500":""]])},[Bi(xn(k)+" ",1),zn(t).markedQuestions.has(k-1)?(hn(),Cn("span",tf)):Pe("",!0)],10,ef))),128))])])],2),l.value?(hn(),Cn("div",sf,[L("div",rf,[L("div",of,[L("div",lf,[L("h2",cf," 第 "+xn(f.value+1)+" 题 ",1),L("button",{onClick:Z,class:ie(["p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700",{"text-red-500 dark:text-red-400":z.value}])},_[8]||(_[8]=[L("svg",{class:"w-6 h-6",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[L("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M5 5a2 2 0 012-2h10a2 2 0 012 2v16l-7-3.5L5 21V5z"})],-1)]),2)]),L("div",uf,[L("span",af,xn(f.value+1)+" / "+xn(p.value),1),L("button",{onClick:_[3]||(_[3]=k=>R.value=!0),class:"p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700"},_[9]||(_[9]=[L("svg",{class:"w-6 h-6 text-gray-600 dark:text-gray-300",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},[L("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M4 6h16M4 12h16M4 18h16"})],-1)]))])]),L("p",ff,xn(l.value.content),1),L("div",df,[l.value.type==="single"||l.value.type==="boolean"?(hn(!0),Cn(Tn,{key:0},xt(l.value.options,k=>(hn(),Cn("div",{key:k,onClick:w=>g(l.value.type==="boolean"?k:k[0]),class:ie(["p-4 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md",[F(l.value.type==="boolean"?k:k[0])]])},xn(k),11,hf))),128)):l.value.type==="multiple"?(hn(!0),Cn(Tn,{key:1},xt(l.value.options,k=>(hn(),Cn("div",{key:k,onClick:w=>!s.value&&N(k[0]),class:ie(["p-4 rounded-lg cursor-pointer transition-all duration-200 hover:shadow-md",[I(k[0])]])},xn(k),11,pf))),128)):Pe("",!0)])]),L("div",gf,[L("div",Cf,[L("button",{onClick:j,disabled:f.value===0,class:ie(["px-6 py-2 rounded-lg transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed",f.value===0?"bg-gray-100 dark:bg-gray-700 text-gray-400 dark:text-gray-500":"bg-white dark:bg-gray-800 text-blue-600 dark:text-blue-400 border-2 border-blue-600 dark:border-blue-400 hover:bg-blue-50 dark:hover:bg-blue-900/50"])}," 上一题 ",10,Af),l.value.type==="multiple"&&!s.value?(hn(),Cn("button",{key:0,onClick:y,disabled:!i.value,class:"px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"}," 确认答案 ",8,mf)):Pe("",!0),L("button",{onClick:E,class:"px-6 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg hover:opacity-90 transition-all duration-200"},xn(d.value?"完成":"下一题"),1)])])])):Pe("",!0),c.value?(hn(),Cn("div",Bf,[L("div",Df,[_[10]||(_[10]=L("h3",{class:"text-lg font-bold mb-4 text-gray-800 dark:text-white"},"确认交卷",-1)),_[11]||(_[11]=L("p",{class:"text-gray-600 dark:text-gray-300 mb-6"},"确定要交卷吗？请确认所有题目都已完成。",-1)),L("div",vf,[L("button",{onClick:_[4]||(_[4]=k=>c.value=!1),class:"bg-gray-500 px-4 py-2 text-white hover:bg-gray-600 rounded-lg"}," 取消 "),L("button",{onClick:V,class:"cursor-pointer bg-gradient-to-r from-[#EB3349] to-[#F45C43] px-4 py-1.5 rounded text-white text-sm font-semibold hover:opacity-90"}," 确认交卷 ")])])])):Pe("",!0)]))}}),_f=(n,e)=>{const t=n.__vccOpts||n;for(const[s,r]of e)t[s]=r;return t},yf=_f(bf,[["__scopeId","data-v-e59ddbf3"]]),xf={class:"max-w-4xl mx-auto p-4"},Sf={class:"bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8"},wf={class:"space-y-6"},Ef={class:"bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/50 dark:to-indigo-900/50 rounded-lg p-6"},Pf={class:"text-center"},Tf={class:"text-4xl font-bold text-blue-600 dark:text-blue-400"},Rf={class:"mt-2 text-gray-600 dark:text-gray-300"},Of=qe({__name:"QuizResult",setup(n){nr();const e=er(),t=An(()=>e.score),s=An(()=>{var r;return((r=e.currentQuizBank)==null?void 0:r.questions.length)||0});return(r,o)=>(hn(),Cn("div",xf,[L("div",Sf,[o[0]||(o[0]=L("h2",{class:"text-2xl font-bold text-gray-800 dark:text-white mb-6"},"结果",-1)),L("div",wf,[L("div",Ef,[L("div",Pf,[L("div",Tf,xn(t.value)+" / "+xn(s.value),1),L("div",Rf," 正确率: "+xn(Math.round(t.value/s.value*100))+"% ",1)])])])])]))}}),kf=xa({history:na("/prv-shuati/"),routes:[{path:"/",component:Ka},{path:"/quiz",component:yf},{path:"/result",component:Of}]}),Mf={class:"min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-gray-900 dark:to-gray-800"},If={class:"bg-white dark:bg-gray-800 shadow-md"},Lf={class:"max-w-4xl mx-auto p-4 flex justify-between items-center"},Nf={class:"flex items-center gap-4"},Ff={key:0,class:"w-6 h-6 text-yellow-500",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},$f={key:1,class:"w-6 h-6 text-gray-600",fill:"none",viewBox:"0 0 24 24",stroke:"currentColor"},Hf={class:"container mx-auto px-4 py-2"},jf=qe({__name:"App",setup(n){const e=Un(!1),t=()=>{e.value=!e.value,e.value?(document.documentElement.classList.add("dark"),localStorage.setItem("darkMode","true")):(document.documentElement.classList.remove("dark"),localStorage.setItem("darkMode","false"))};return qt(()=>{localStorage.getItem("darkMode")==="true"&&(e.value=!0,document.documentElement.classList.add("dark"))}),(s,r)=>{const o=ql("router-view");return hn(),Cn("div",Mf,[L("header",If,[L("div",Lf,[r[3]||(r[3]=L("h1",{class:"text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400"}," 小浩刷题系统 ",-1)),L("div",Nf,[L("button",{onClick:t,class:"p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700"},[e.value?(hn(),Cn("svg",Ff,r[1]||(r[1]=[L("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M12 3v1m0 16v1m9-9h-1M4 12H3m15.364 6.364l-.707-.707M6.343 6.343l-.707-.707m12.728 0l-.707.707M6.343 17.657l-.707.707M16 12a4 4 0 11-8 0 4 4 0 018 0z"},null,-1)]))):(hn(),Cn("svg",$f,r[2]||(r[2]=[L("path",{"stroke-linecap":"round","stroke-linejoin":"round","stroke-width":"2",d:"M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"},null,-1)])))]),s.$route.path!=="/"?(hn(),Cn("button",{key:0,onClick:r[0]||(r[0]=i=>s.$router.push("/")),class:"cursor-pointer bg-gradient-to-r from-[#EB3349] to-[#F45C43] px-4 py-1.5 rounded text-white text-sm font-semibold shadow-[rgba(6,_24,_44,_0.4)_0px_0px_0px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-1px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset] hover:shadow-[rgba(6,_24,_44,_0.4)_0px_0px_0px_2px,_rgba(6,_24,_44,_0.65)_0px_4px_6px_-10px,_rgba(255,_255,_255,_0.08)_0px_1px_0px_inset] focus:shadow-[inset_-12px_-8px_40px_#46464620] transition-shadow"}," 退出 ")):Pe("",!0)])])]),L("main",Hf,[En(o,null,{default:vs(({Component:i})=>[En(zc,{name:"fade",mode:"out-in"},{default:vs(()=>[(hn(),Ai(Wl(i)))]),_:2},1024)]),_:1})])])}}}),tr=hu(jf);tr.use(Au());tr.use(kf);tr.mount("#app");
